...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2595906f3c428038b08ae6ed8edf6e5f,en:2625906f3c42801b8182d95407f80ed8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SoMic', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://somac.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Soil Health Researcher', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 嘎ICP备 5201314', // 备案号 闽ICP备XXXXXX
  ...
  ...require('./conf/auth.config')，  // ✅ 新增这一行：把登录开关合并进来
