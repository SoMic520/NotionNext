  ...
  return (
    <div className="links-wrap">
                          ...
                          <div className="icon">
                            <img
                              ...
                              onError={e => {
                                ...
                                // 0 -> 尝试 DuckDuckGo，失败则 1 -> Google S2，失败则 2 -> 本地
                                if (step === 0 && host) {
      ...
      <style jsx>{`
        ...
        .group-title {
          font-size: 19px; /* 分组标题略大 */
          font-weight: 750; color: var(--txt); margin: 0;
        }
        ...
        .card {
          ...
          padding: 16px; /* 内边距更舒适 */
          border-radius: var(--radius); /* 圆角卡片 */
          text-decoration: none;
          background: var(--card);
          border: 1px solid var(--line); /* 带框 */
          box-shadow:
            0 1px 1px rgba(var(--shadow), 0.04),
            0 10px 18px rgba(var(--shadow), 0.06);
        ...
        .card:hover {
          ...
          box-shadow:
            0 2px 4px rgba(var(--shadow), 0.06),
            0 16px 28px rgba(var(--shadow), 0.10);
          border-color: rgba(var(--ring), .45);
          background:
            radial-gradient(900px 180px at 96% 0%, rgba(var(--glow), .06), transparent 55%) var(--card);
        }
        .card:focus-visible {
          outline: none;
          box-shadow:
            0 0 0 2px rgba(var(--ring), .9),
            0 12px 26px rgba(var(--shadow), .10);
        }

        .icon {
          flex: 0 0 auto;
          width: 48px; height: 48px; /* 图标更大 */
          border-radius: 12px; /* 图标圆角更大 */
          overflow: hidden;
        ...
        .shine {
          ...
          mask: radial-gradient(220px 140px at 96% 4%, #000 20%, transparent 60%);
        }
